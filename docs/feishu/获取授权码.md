 ...
 * @Date: 2026-08-04 09:25:15
 * @LastEditors: 17630921248 1245634367@qq.com
 * @LastEditTime: 2026-08-04 09:25:16
 * @FilePath: \feishu-work-web\docs\feishu\获取授权码.md
...
1. 一次性拼接所有需要用户授权的 `scope`，在无新增权限需求的情况下，无需重复授权。需注意单次拼接的 `scope` 数量上限为 200 个。  
